...
export default function ExploreMenu({setCategory,category}) {
  return (
    <Element name="menu">
      <div name="menu" className="w-[100vw] ">
      <div className="w-10/12 mx-auto">
        <h1 className=" font-heading text-center text-[3rem]">Explore Our Menu</h1>
        <p className=" font-content text-[1.5rem] text-center">Choose from a diverse menu</p>
